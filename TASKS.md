...
- 2025-10-18: DOC-B14 をバックログへ追加し、docs/roadmap.md の DOC-B14 記述修正を対象として追跡開始（旧 DOC-B12 から改番）。
- 2025-10-18: DOC-B14 へ改番した旧 DOC-B12 の完了扱いを docs/tasks/backlog.md に反映し、チェック済みへ更新。重複タスク運用ルールに従い、同系統の DOC-B13 は参照修正タスクとして継続中であることを明記。

...
- [OPS-04] ランタイムメトリクス（`src/llm_generic_bot/infra/metrics/__init__.py` 新設、`src/llm_generic_bot/infra/metrics/reporting.py`/`src/llm_generic_bot/infra/metrics/service.py` 連携）: スケジューラ遅延や送信成功率を可視化。
